...
import 'package:crm_prasarana_mobile/common/components/buttons/add_icon_button.dart';
...
import 'package:crm_prasarana_mobile/common/components/text-form-field/custom_multi_drop_down_text_field.dart';
...
import 'package:crm_prasarana_mobile/common/models/currencies_model.dart';
import 'package:crm_prasarana_mobile/common/models/payment_modes_model.dart';
...
import 'package:crm_prasarana_mobile/features/invoice/controller/invoice_controller.dart';
import 'package:crm_prasarana_mobile/features/invoice/model/invoice_item_model.dart';
import 'package:crm_prasarana_mobile/features/invoice/repo/invoice_repo.dart';
import 'package:crm_prasarana_mobile/features/item/model/item_model.dart';
...
class _UpdateInvoiceScreenState extends State<UpdateInvoiceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: LocalStrings.updateInvoice.tr,
      ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder(
                              future:
                                  itemsMemoizer.runOnce(controller.loadItems),
                  ...
                  : RoundedButton(
                      ...
                      press: () {
                        controller.submitInvoice(
                            invoiceId: widget.id, isUpdate: true);
                      },
                    );
        }),
      ),
