...
import 'package:crm_prasarana_mobile/features/proposal/controller/proposal_controller.dart';
import 'package:crm_prasarana_mobile/features/proposal/repo/proposal_repo.dart';
...
class _UpdateProposalScreenState extends State<UpdateProposalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: LocalStrings.updateProposal.tr,
      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (controller.proposalRelatedController.text ==
                            ...
                            FutureBuilder(
                                future:
                                    leadsMemoizer.runOnce(controller.loadLeads),
      ...
      bottomNavigationBar: Padding(
        ...
        child: GetBuilder<ProposalController>(builder: (controller) {
          return controller.isLoading
                  ...
                  : RoundedButton(
                      ...
                      press: () {
                        controller.submitProposal(
                            proposalId: widget.id, isUpdate: true);
                      },
                    );
        }),
      ),
